...
@mcp_for_unity_tool(
    description="""Manage components on GameObjects: add, remove, set_property.

For reading component data, use mcpforunity://scene/gameobject/{id}/components resource."""
)

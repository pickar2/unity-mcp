...
async def manage_asset(
    ...
    path: Annotated[
        str,
        "Asset path (e.g., 'Materials/MyMaterial.mat') or search scope (e.g., 'Assets').",
    ],
    ...
    generate_preview: Annotated[
        ...
        "Warning: previews may include large base64 payloads; keep false unless needed.",
    ] = False,
    ...
    page_size: Annotated[
        int | float | str,
        "Page size for pagination. Recommended: 25 (smaller for LLM-friendly responses).",
    ]
    | None = None,
    page_number: Annotated[int | float | str, "Page number for pagination (1-based)."]
    | None = None,
) -> dict[str, Any]:
